...
namespace presentacion
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        private void listarDatos()
        {
            ...
            grd_listaClientes.DataSource = vlo_logicaCliente.listaRegistros(); // obteniendo los registros de la base de datos
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                idCliente = logicaCliente.guardar(cliente);
        ...
        private void cargarDatos(int idCliente)
        {
            ...
            try
            {
                vlo_cliente = vlo_logicaCliente.obtenerRegistro(idCliente);
        ...
        public void eliminarRegistro(int pvn_idCliente)
        {
            ...
            try
            {
                vlc_mensaje = vlo_logicaCliente.eliminar(pvn_idCliente);
                listarDatos(); //cargando los registros en el grid
            }
            catch (Exception)
            {
